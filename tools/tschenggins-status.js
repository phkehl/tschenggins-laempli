...
$(document).ready(function ()
{
    ...
    $('input.tab-input').on('click', function (e)
    {
        ...
        if (id === 'tab-config')
        {
            ...
            {
                $('input[name=tabs-config]').prop('checked', '');
            }
        }
    ...
    $('.action-modify-job').on('click', function (e)
    {
        ...
        $("#modify-job-form input[name='job'][value='" + jobId + "']").prop('checked', true)
    ...
    $('.action-delete-job').on('click', function (e)
    {
        ...
        $("#delete-job-form input[name='job'][value='" + jobId + "']").prop('checked', true)
            .get(0).scrollIntoView();
    });
